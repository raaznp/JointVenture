    ...
    return (
        <div className="p-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden min-h-[600px] flex flex-col">
                {/* Tabs Header */}
                <div className="border-b border-gray-200 flex overflow-x-auto bg-gray-50/50">
                    <button
                        ...
                        <form onSubmit={handleUpdateProfile} className="space-y-8 max-w-4xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 focus:ring-2 focus:ring-blue-600 outline-none transition-colors"
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 focus:ring-2 focus:ring-blue-600 outline-none transition-colors"
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        value={profile.role}
                                        readOnly
                                        className="w-full px-4 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-500 cursor-not-allowed capitalize"
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 focus:ring-2 focus:ring-blue-600 outline-none transition-colors resize-none"
                            ...
                            <div className="flex justify-end pt-4">
                                <button type="submit" className="flex items-center px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors shadow-lg">
                            ...
                            {education.map((item, index) => (
                                <div key={index} className="bg-gray-50 p-6 rounded-xl border border-gray-200 relative group">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <label className="text-xs font-medium text-gray-500 uppercase">School / University</label>
                                            <input
                                                type="text"
                                                value={item.school}
                                                onChange={(e) => handleEducationChange(index, 'school', e.target.value)}
                                                className="w-full mt-1 px-3 py-2 bg-white border border-gray-300 rounded-lg text-gray-900 focus:ring-2 focus:ring-blue-600 outline-none"
                                        ...
                                        <div className="md:col-span-2">
                                            <label className="text-xs font-medium text-gray-500 uppercase">Year / Duration</label>
                                            <input
                                                type="text"
                                                value={item.year}
                             ...
                             {education.length > 0 && (
                                <div className="flex justify-end pt-4">
                                    <button onClick={handleUpdateProfile} className="flex items-center px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors">
                                        <Save className="w-4 h-4 mr-2" />
                                        Save Education
                                    </button>
                                </div>
                            ...
                            {workHistory.map((item, index) => (
                                <div key={index} className="bg-gray-50 p-6 rounded-xl border border-gray-200 relative group">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <label className="text-xs font-medium text-gray-500 uppercase">Role / Title</label>
                                            <input
                                                type="text"
                                                value={item.role}
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full mt-1 pl-8 pr-3 py-2 bg-white border border-gray-300 rounded-lg text-gray-900 focus:ring-2 focus:ring-blue-600 outline-none"
                                                    placeholder="City, Country"
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div className="md:col-span-2">
                                            ...
                                            <textarea
                                                ...
                                                className="w-full mt-1 px-3 py-2 bg-white border border-gray-300 rounded-lg text-gray-900 focus:ring-2 focus:ring-blue-600 outline-none resize-none"
